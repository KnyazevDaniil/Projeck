    ...
    <div class="container">
        ...
        <div class="nav-scroller py-1 mb-2 h5">
            <nav class="nav d-flex justify-content-between">
                <a class="p-2 text-primary" href="{{route('main')}}">Свежие новости</a>
                @foreach($tags as $tag)
                    @if($tag->id == $req->tag_id)
                        <a class="p-2 text-muted " disabled>{{$tag->name}}</a>
                    @else
        ...
        @if($news->count()>0)
            <div class="jumbotron p-4 p-md-5 text-white rounded bg-dark">
                <div class="col-md-6 px-0">
                    ...
                    <p class="lead my-3">{{$news[0]->preview}}</p>
                    <p class="lead mb-0"><a href="{{$news[0]->id}}" class="text-white font-weight-bold">Подробнее...</a></p>
                </div>
            </div>
        @endif
                ...
                <div class="col-md-6">
                    <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                        ...
                        <div class="col-auto d-none d-lg-block">
                            <svg class="bd-placeholder-img" width="200" height=50% xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: Thumbnail"><title>Placeholder</title><rect width="100%" height="100%" fill="#55595c"/><text x="50%" y="50%" fill="#eceeef" dy=".3em">Thumbnail</text></svg>
                        </div>
                    </div>
                </div>
